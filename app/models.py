...
class SamplePreparation(Base):
    ...
    dyes = Column(Integer,nullable=True)
    needles = Column(Integer,nullable=True)
    dye_name = Column(String(500),nullable=True)
    perfusion_user = Column(String(50),nullable=True)
    perfusion_date = Column(String(50),nullable=True)
...
class ImagingRecord(Base):
    ...
    File_Size_GB = Column(Float, nullable=True)
    # 关系定义
