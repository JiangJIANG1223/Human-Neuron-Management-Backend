...
HNDB_files = os.path.join(NFS_BASE, "HNDB_files")
# Static files
STATIC_DIR = "static"

# Sample directories
SAMPLE_FILES_DIR = os.path.join(HNDB_files, "Sample_Files")
...
# Sample preparation
SAMPLE_PREPARATION_DIR = os.path.join(HNDB_files, "SamplePreparation")
...
# Injection files
INJECTION_FILES_BASE = os.path.join(HNDB_files, "Injection_Files")
...
# Imaging files
IMAGING_FILES_BASE = os.path.join(HNDB_files, "Imaging_Files")
...
# Image DB directory
PTRSB_DB_DIR = os.path.join(NFS_BASE, "PTRSB_DB")
